...
class StackoverflowEmailSpider(scrapy.Spider):
	...
	start_urls = ['https://stackoverflow.com/questions/53555426/'\
					'python-selenium-chromedirver-headerless-use-proxies-ipv6-with-authenticatio']
